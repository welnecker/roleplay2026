...
NOVEL_FRAME_BUILD = "2026-08-25.synced-image-carousel.11"
_BUILD_LOGGED = False
...
def _execute_runtime() -> dict[str, Any]:
    ...
    if not _BUILD_LOGGED:
        print(
            ...
            "carrossel imagem+balão sincronizado com foco automático no slide mais recente, enquadramento integral sem crop, balões padronizados com caudas consistentes, onboarding direto após nome e gênero, tipografia editorial, binding de versão e continuidade canônica autoritativa"
        )
        _BUILD_LOGGED = True
