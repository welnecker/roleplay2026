...
def payment_services() -> tuple[
    ...
    A página não inicializa SAVES, SESSIONS, INTERACTIONS nem a planilha de
    runtime narrativo. Isso evita a rajada de leituras que ocorria antes de a
    história ser aberta.
    """
    ...
    try:
        ...
        # executar ensure_schema() e reler todos os cabeçalhos a cada processo.
